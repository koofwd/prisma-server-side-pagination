export class PaginationService {
    ...
    async getPagingData(table: any, page: number, limit: number, search: any) {
      if (this.checkSearch(search)) {
        return this.getPagingDataWithoutSearch(table, page, limit);
      } else {
        return this.getPagingDataWithSearch(table, page, limit, search);
      }
    }
  }
